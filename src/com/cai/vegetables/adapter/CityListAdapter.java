...
import com.cai.vegetables.view.PinnedHeaderListView.PinnedHeaderAdapter;
...
PinnedHeaderAdapter, OnScrollListener {
	...
	public CityListAdapter(Activity context,List<City> datas, List<String> friendsSections,
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		textView.setText(mDatas.get(position).getCity_name());
		textView.setOnClickListener(new OnClickListener() {
			
			@Override
			public void onClick(View v) {
//				CityDao.updateData(mDatas.get(position).getCity_name());
//				EventBus.getDefault().post(
//						new CountryEvent(mDatas.get(position).getCity_name()));
				context.finish();
			}
		});
		return convertView;
