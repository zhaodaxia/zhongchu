 ...
 *
 */
public class ChooseWorkAct extends CookBase {
	@ViewInject(R.id.choose_foodlv)
	private ListView flv;
	private CookBookAda adapter;

	private int width;
	private List<String> kitchendatalist;
	@Override
	...
	public void initCook(Bundle savedInstanceState) {
		...
		kitchendatalist=new Gson().fromJson(json,new TypeToken<List<String>>() {
		}.getType());
	...
	public void todo(View v) {
		...
		case R.id.bt_savefood:
			...
			reintent.putExtra(COOKUSE, (Serializable)kitchendatalist);
	...
	private class CookBookAda extends BaseAdapter {
		...
		public View getView(final int position, View convertView, ViewGroup parent) {
			...
			if (convertView != null && convertView instanceof HorizontalScrollView) {
				...
				convertView = View.inflate(ChooseWorkAct.this, R.layout.choosework_item, null);
				...
				holder.tv_kitchen=(TextView) convertView.findViewById(R.id.tv_kitchen);
			...
			holder.action.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View v) {
					...
					kitchendatalist.remove(position);
					notifyDataSetChanged();
					vh.hSView.smoothScrollTo(0, 0);
				}
			});
			holder.tv_kitchen.setText(kitchendatalist.get(position));
